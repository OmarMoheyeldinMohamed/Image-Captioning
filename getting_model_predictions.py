...
model_path = input("Enter model wieghts path: ")

is_gpu = True

model_type = "RN50x4" #@param ["ViT-B/32", "RN50", "RN50x4"]
...
prediction = {}
for key in tqdm(evaluation_dataset):
  image = io.imread(val_dir+key)
  ...
  prediction[key] = generated_text_prefix

with open('coco_prefix_prediction.json', 'w') as f:
